        ...
        return this.executeJob(job, async (data) => {
            ...
            switch (job.name) {
                case JobType.SEND_VERIFICATION_EMAIL:
                    return this.sendVerificationEmail(to as string, subject, templateData);
                case JobType.SEND_PASSWORD_RESET_EMAIL:
                    return this.sendPasswordResetEmail(to as string, subject, templateData);
                case JobType.SEND_NOTIFICATION_EMAIL:
                    return this.sendNotificationEmail(to, subject, template, templateData);
                default:
