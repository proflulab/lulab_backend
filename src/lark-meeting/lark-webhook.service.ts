 ...
 * @LastEditTime: 2025-09-25 21:09:29
 * @FilePath: \lulab_backend\src\feishu-meeting\feishu-webhook.service.ts
 * @Description: 
 * 
...
export class LarkWebhookHandler {
    ...
    constructor(private readonly configService: ConfigService) {
        ...
        const verificationToken = this.configService.get<string>('LARK_VERIFICATION_TOKEN') || '';
        ...
        'vc.meeting.all_meeting_ended_v1': async (data) => {
            ...
            this.logger.log('[handler] vc.meeting.all_meeting_ended_v1 -> ' + JSON.stringify(data));
