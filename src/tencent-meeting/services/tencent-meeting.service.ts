...
export class TencentMeetingService {
  ...
  async getRecordingFileDetail(
    ...
    try {
      ...
      const result = await this.tencentApiService.getRecordingFileDetail(
        fileId,
        userId,
      );
  ...
  async getMeetingDetail(
    ...
    try {
      ...
      const result = await this.tencentApiService.getMeetingDetail(
        meetingId,
        userId,
        instanceId,
      );
  ...
  async getMeetingParticipants(
    ...
    try {
      ...
      const result = await this.tencentApiService.getMeetingParticipants(
        meetingId,
        userId,
        subMeetingId,
      );
